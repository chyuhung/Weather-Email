...
| **分时段预报** | 上午/下午/晚间三时段，显示温度区间、风力、湿度和降水概率 |
...
├── preview_demo.py             # 本地多天气预览生成器（15 种天气场景）
...
内置 `preview_demo.py` 可一键生成 15 种天气场景（晴、多云、阴、小雨、暴雨、小雪、大雪、雾、浓雾、微风、大风、雷阵雨、强雷暴、高温）的早晚双模式邮件 HTML：
...
- 三时段卡片：上午/下午/晚间（温度区间、风向风力、降水概率、湿度）
